...
real_estate = real_estate[(real_estate.RESCOMM == 'commercial') & (real_estate.Longitude != 0) & (real_estate['2019ASSESSMENT'] > 50000)].copy()
# real_estate = real_estate.sample(9890,random_state=42)
...
df.to_csv('MobilityDistance/tax_commercial_mobility_distance_500_no_impute.csv', index=False)